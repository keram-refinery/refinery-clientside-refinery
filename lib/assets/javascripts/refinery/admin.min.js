(function(window, $){'use strict';(function(b){b.admin={ui:{},backend_path:function(){var a=document.location.pathname.split("/").filter(function(a){return""!==a});return/^[a-z]{2}(-[a-zA-Z]{2,3})?$/.test(a[0])?"/"+a[0]+"/"+a[1]:"/"+a[0]}}})(refinery);(function(b){b.Object.create({name:"Form",module:"admin",k:function(a){var d=this,c,b,e,g;c={text:t("refinery.admin.form_unsaved_save_and_continue"),"class":"submit-button",click:function(){var c=d.holder,b=a.attr("class").match(/flag-([a-z]{2}(?:-[a-zA-Z]{2,3})?)?$/)[1];$("<input/>",{type:"hidden",name:"switch_frontend_locale",value:b}).appendTo(c);c.trigger("before-submit");c.submit()}};b={text:t("refinery.admin.form_unsaved_continue"),click:function(){Turbolinks.visit(a.attr("href"))}};e={text:t("refinery.admin.form_unsaved_cancel"),
click:function(){g.dialog("close")}};g=$("<div/>",{html:t("refinery.admin.form_unsaved_html")}).dialog({resizable:!1,height:140,modal:!0,title:t("refinery.admin.form_unsaved_title"),buttons:[c,b,e]});d.on("destroy",function(){g.dialog("destroy")})},g:function(){var a=this,d=a.holder;d.on("click",".locale-picker a",function(c){a.b!==d.serialize()&&(c.preventDefault(),c.stopPropagation(),a.k($(this)))})},i:function(){var a=this.holder,d=$("meta[name=csrf-param]").attr("content"),c=a.find('input[type="file"]');
if(0<c.length)a.on("submit",function(f){f.preventDefault();f.stopPropagation();b.spinner.on();0===a.find('input[name="'+d+'"]').length&&$("<input/>",{name:d,type:"hidden",value:$("meta[name=csrf-token]").attr("content")}).appendTo(a);a.trigger("before-submit");$.ajax(this.action,{data:a.serializeArray(),files:c,iframe:!0,processData:!1}).done(function(d,c,b){a.trigger("ajax:success",[d,c,b])}).always(function(){b.spinner.off()})})},h:function(){function a(a){a.stopPropagation()}function d(){if(c.is(":valid")){c.removeData("remote");
c.removeAttr("data-remote");if(!k||k.closed)k=window.open("",h.attr("href"));c.attr({action:h.attr("href"),method:"POST",target:h.attr("href")});c.trigger("before-submit");c.on("submit",a);c.submit();c.off("submit",a);c.attr({action:b,method:g,target:e});l&&(c.attr("data-remote",l),c.data("remote",l))}else alert("Preview is not possible because form is not filled properly!")}var c=this.holder,b=c.attr("action"),e=c.attr("target"),g=c.attr("method"),l=c.data("remote"),h=c.find(".preview-button"),k;
0<h.length&&(c.on("click",".preview-button",function(a){a.preventDefault();a.stopPropagation();d()}),c.on("change","input, select, textarea",function(){k&&!k.closed&&d()}))},f:function(){var a=this,d=a.holder,c=d.find(".form-actions .submit-button"),b;0<c.length&&(b=c.val(),d.on("change","input, select, textarea",function(){a.b!==d.serialize()&&"!"!==b[b.length]?c.val(b+" !"):c.val(b.replace(/ !$/,""))}));d.find("input.autocomplete").each(function(){var a=$(this),d,c=a.data("autocomplete");c.multiple&&
(d=c.source,a.bind("keydown",function(a){a.keyCode===$.ui.keyCode.TAB&&$(this).data("ui-autocomplete").menu.active&&a.preventDefault()}),$.extend(c,{select:function(a,d){var c=this.value.split(/,\s*/);c.pop();c.push(d.item.value);c.push("");this.value=c.join(", ");return!1},source:function(a,c){var b=a.term.split(/,\s*/),f=b.pop(),e=d.filter(function(a){return-1===b.indexOf(a)});c($.ui.autocomplete.filter(e,f))},focus:function(){return!1}}));a.autocomplete(c)})},e:function(){function a(){var a=d.scrollTop()+
...
return this}});b.admin.ui.form=function(a,d){a.find("form").each(function(){d.addObject(b("admin.Form").init($(this)))})}})(refinery);(function(b){b.Object.create({name:"FormPageParts",module:"admin",c:function(a){for(var d,c='<ul class="records">',b=0,e=a.length;b<e;b++)d=a[b],c+='<li data-part="'+d.name+'" class="clearfix" ><label class="stripped"><input type="checkbox"'+(d.active?' checked="1"':"")+'"> '+d.title+'</label> <span class="actions"><span class="icon-small move-icon">'+t("refinery.admin.button_move")+"</span></span></li>";return c+"</ul>"},d:function(){function a(){var a=[],g;e.find("li").each(function(d){var b=$(this),
f=b.data("part"),b=b.find("input").is(":checked"),e=c.find('li[aria-controls="page_part_'+f+'"]').detach(),g=$("#page_part_"+f);b?(e.removeClass("js-hide"),g.removeClass("js-hide")):(e.removeClass("ui-tabs-active ui-state-active"),e.addClass("js-hide"),g.addClass("js-hide"));g.find("input.part-active").prop("checked",b);g.find("input.part-position").val(d);"title"!==f&&(a[a.length]=e)});for(g=a.length;0<=g;g--)c.prepend(a[g]);0===c.find(".ui-tabs-active").length&&d.tabs({active:b.index(c.find("li:visible").first())})}
var d=this.holder,c=d.find(".ui-tabs-nav"),b=c.find("li"),e=$("<div/>"),g;e.html(this.c(d.find("#page_parts-options").data("page-parts")));e.on("change","li input",a);e.find("ul").sortable({stop:a});g=[{text:t("refinery.admin.button_done"),"class":"submit-button",click:function(){a();e.dialog("close")}}];e.dialog({title:t("refinery.admin.form_page_parts_manage"),modal:!0,resizable:!0,autoOpen:!1,width:400,buttons:g});d.on("click","#page_parts-options",function(a){a.preventDefault();e.dialog("open")});
this.on("destroy",function(){e.dialog("destroy");e.off()})},init:function(a){this.is("initialisable")&&(this.is("initialising",!0),this.holder=a,this.d(),this.is({initialised:!0,initialising:!1}),this.trigger("init"));return this}});b.admin.ui.formPageParts=function(a,d){a.find("#page_parts").each(function(){d.addObject(b("admin.FormPageParts").init($(this)))})}})(refinery);(function(b){b.Object.create({objectConstructor:function(a,d){var c=this;b.Object.apply(c,arguments);d||(c.options.nested_sortable.stop=function(a,d){c.update(d.item)})},name:"SortableList",module:"admin",options:{nested_sortable:{m:"ul",items:"li",n:1}},set:null,html:null,a:function(a){return a.attr("id")&&/([0-9]+)$/.test(a.attr("id"))?a.attr("id").match(/([0-9]+)$/)[1]:null},update:function(a){var d=this,c=d.holder,f=c.data("update_positions_url"),e=c.nestedSortable("toArray");a={item:{id:d.a(a),
prev_id:d.a(a.prev()),next_id:d.a(a.next()),parent_id:d.a(a.parent().parent())}};d.is("updating")||JSON.stringify(e)===JSON.stringify(d.set)||(d.is({updating:!0,updated:!1}),c.nestedSortable("disable"),b.spinner.on(),$.post(f,a,function(a,f,h){"error"===f?c.html(d.html):(d.set=e,d.html=c.html());b.xhr.success(a,f,h,c);d.is("updated",!0);d.trigger("update")},"JSON").fail(function(a){c.html(d.html);b.xhr.error(a)}).always(function(){b.spinner.off();d.is("updating",!1);c.nestedSortable("enable")}));
...
this,c=a.holder;c.on("click",".cancel-button, .close-button",function(c){c.preventDefault();a.close();return!1});c.on("submit","form",function(c){var b=$(this);b.attr("action")||(c.preventDefault(),c.stopPropagation(),a.insert(b))})},load:function(){var a=this,c=a.holder,f=b.admin.backend_path()+a.options.url_path,e=$("#frontend_locale");a.is("loadable")&&(a.is("loading",!0),e={id:a.id,frontend_locale:0<e.length?e.val():"en"},f=$.ajax(f,e),f.fail(function(){c.html($("<div/>",{"class":"flash error",
html:t("refinery.admin.dialog_content_load_fail")}))}),f.done(function(e,f,h){var k;"success"===f&&(c.empty(),k=$("<div/>").appendTo(c),b.xhr.success(e,f,h,k),a.l(k),a.is("loaded",!0))}),f.always(function(){a.is("loading",!1);c.removeClass("loading");a.trigger("load")}));return this},l:function(a){var c=this,f;(function g(){f=b("admin.UserInterface",{main_content_selector:".dialog-content-wrapper"}).init(a);f.subscribe("ui:change",function(){f.destroy();g()});c.on("destroy",function(){f.destroy()})})()},
