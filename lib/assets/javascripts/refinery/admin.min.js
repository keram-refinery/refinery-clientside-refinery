...
html:t("refinery.admin.dialog_content_load_fail")}))}),e.done(function(f){var e=$("<div/>");c.empty();e.appendTo(c);b.xhr.success(f,e);a.l(e);a.is("loaded",!0)}),e.always(function(){a.is("loading",!1);c.removeClass("loading");a.trigger("load")}));return this},l:function(a){var c=this,e;(function g(){e=b("admin.UserInterface",{main_content_selector:".dialog-content-wrapper"}).init(a);e.subscribe("ui:change",function(){e.destroy();g()});c.on("destroy",function(){e.destroy()})})()},bind_events:function(){var a=
