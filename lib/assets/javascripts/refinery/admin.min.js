(function(window, $){'use strict';(function(b){b.admin={ui:{},backend_path:function(){var a=document.location.pathname.split("/").filter(function(a){return""!==a});return/^[a-z]{2}(-[a-zA-Z]{2,3})?$/.test(a[0])?"/"+a[0]+"/"+a[1]:"/"+a[0]}}})(refinery);(function(b){b.Object.create({name:"Form",module:"admin",c:function(a){var d=window.location;return/^http(s)?:/.test(a)?a:d.protocol+"//"+d.host+a},e:function(a,d){var c,e,b,g;a=this.c(a);return d?(e=/^[a-z]{2}(-[a-zA-Z]{2,3})?$/,c=a.split("/")[3],b=d.split("/"),g=b[3],e.test(g)?e.test(c)?b.splice(3,1,c):b.splice(3,1):b=[].concat(b.splice(0,3),c,b),b.join("/")):a},m:function(a){var d=this,c=a.attr("href"),e,f,g;a={text:t("refinery.admin.form_unsaved_save_and_continue"),"class":"submit-button",click:function(){var a=
d.holder;a.trigger("before-submit");$.ajax({url:a.attr("action"),method:a.attr("method"),data:a.serialize(),dataType:"JSON"}).done(function(e,f,m){g.dialog("destroy");"error"===f?b.xhr.success(e,f,m,a,!0):Turbolinks.visit(d.e(c,m.getResponseHeader("X-XHR-Redirected-To")))})}};e={text:t("refinery.admin.form_unsaved_continue"),click:function(){g.dialog("destroy");Turbolinks.visit(c)}};f={text:t("refinery.admin.form_unsaved_cancel"),click:function(){g.dialog("destroy")}};g=$("<div/>",{html:t("refinery.admin.form_unsaved_html")}).dialog({resizable:!1,
height:140,modal:!0,title:t("refinery.admin.form_unsaved_title"),buttons:[a,e,f]});d.on("destroy",function(){g.dialog("destroy")})},i:function(){var a=this,d=a.holder;d.on("click",".locale-picker a",function(c){a.b!==d.serialize()&&(c.preventDefault(),c.stopPropagation(),a.m($(this)))})},k:function(){var a=this.holder,d=$("meta[name=csrf-param]").attr("content"),c=a.find('input[type="file"]');if(0<c.length)a.on("submit",function(e){e.preventDefault();e.stopPropagation();b.spinner.on();0===a.find('input[name="'+
d+'"]').length&&$("<input/>",{name:d,type:"hidden",value:$("meta[name=csrf-token]").attr("content")}).appendTo(a);a.trigger("before-submit");$.ajax(this.action,{data:a.serializeArray(),files:c,iframe:!0,processData:!1}).done(function(d,c,b){a.trigger("ajax:success",[d,c,b])}).always(function(){b.spinner.off()})})},j:function(){function a(a){a.stopPropagation()}function d(){if(c.is(":valid")){c.removeData("remote");c.removeAttr("data-remote");if(!k||k.closed)k=window.open("",h.attr("href"));c.attr({action:h.attr("href"),
method:"POST",target:h.attr("href")});c.trigger("before-submit");c.on("submit",a);c.submit();c.off("submit",a);c.attr({action:b,method:g,target:f});l&&(c.attr("data-remote",l),c.data("remote",l))}else alert("Preview is not possible because form is not filled properly!")}var c=this.holder,b=c.attr("action"),f=c.attr("target"),g=c.attr("method"),l=c.data("remote"),h=c.find(".preview-button"),k;0<h.length&&(c.on("click",".preview-button",function(a){a.preventDefault();a.stopPropagation();d()}),c.on("change",
"input, select, textarea",function(){k&&!k.closed&&d()}))},h:function(){var a=this,d=a.holder,c=d.find(".form-actions .submit-button"),b;0<c.length&&(b=c.val(),d.on("change","input, select, textarea",function(){a.b!==d.serialize()&&"!"!==b[b.length]?c.val(b+" !"):c.val(b.replace(/ !$/,""))}));d.find("input.autocomplete").each(function(){var a=$(this),d,c=a.data("autocomplete");c.multiple&&(d=c.source,a.bind("keydown",function(a){a.keyCode===$.ui.keyCode.TAB&&$(this).data("ui-autocomplete").menu.active&&
a.preventDefault()}),$.extend(c,{select:function(a,d){var c=this.value.split(/,\s*/);c.pop();c.push(d.item.value);c.push("");this.value=c.join(", ");return!1},source:function(a,c){var b=a.term.split(/,\s*/),e=b.pop(),f=d.filter(function(a){return-1===b.indexOf(a)});c($.ui.autocomplete.filter(f,e))},focus:function(){return!1}}));a.autocomplete(c)})},g:function(){function a(){var a=d.scrollTop()+d.height(),g=c.position().top;a<g?b.addClass("fly"):b.removeClass("fly")}var d=$(window),c=this.holder.find(".form-actions"),
b=this.holder.find(".form-actions-left");0<this.holder.find("textarea").length&&0<c.length&&0<b.length&&(d.on("scroll",a),this.on("destroy",function(){d.unbind("scroll",a)}),a())},init:function(a){this.is("initialisable")&&(this.is("initialising",!0),this.holder=a,this.i(),this.h(),this.k(),this.j(),this.b=a.serialize(),this.g(),this.is({initialised:!0,initialising:!1}),this.trigger("init"));return this}});b.admin.ui.form=function(a,d){a.find("form").each(function(){d.addObject(b("admin.Form").init($(this)))})}})(refinery);(function(b){b.Object.create({name:"FormPageParts",module:"admin",d:function(a){for(var d,c='<ul class="records">',b=0,f=a.length;b<f;b++)d=a[b],c+='<li data-part="'+d.name+'" class="clearfix" ><label class="stripped"><input type="checkbox"'+(d.active?' checked="1"':"")+'"> '+d.title+'</label> <span class="actions"><span class="icon-small move-icon">'+t("refinery.admin.button_move")+"</span></span></li>";return c+"</ul>"},f:function(){function a(){var a=[],g;f.find("li").each(function(d){var b=$(this),
e=b.data("part"),b=b.find("input").is(":checked"),f=c.find('li[aria-controls="page_part_'+e+'"]').detach(),g=$("#page_part_"+e);b?(f.removeClass("js-hide"),g.removeClass("js-hide")):(f.removeClass("ui-tabs-active ui-state-active"),f.addClass("js-hide"),g.addClass("js-hide"));g.find("input.part-active").prop("checked",b);g.find("input.part-position").val(d);"title"!==e&&(a[a.length]=f)});for(g=a.length;0<=g;g--)c.prepend(a[g]);0===c.find(".ui-tabs-active").length&&d.tabs({active:b.index(c.find("li:visible").first())})}
var d=this.holder,c=d.find(".ui-tabs-nav"),b=c.find("li"),f=$("<div/>"),g;f.html(this.d(d.find("#page_parts-options").data("page-parts")));f.on("change","li input",a);f.find("ul").sortable({stop:a});g=[{text:t("refinery.admin.button_done"),"class":"submit-button",click:function(){a();f.dialog("close")}}];f.dialog({title:t("refinery.admin.form_page_parts_manage"),modal:!0,resizable:!0,autoOpen:!1,width:400,buttons:g});d.on("click","#page_parts-options",function(a){a.preventDefault();f.dialog("open")});
this.on("destroy",function(){f.dialog("destroy");f.off()})},init:function(a){this.is("initialisable")&&(this.is("initialising",!0),this.holder=a,this.f(),this.is({initialised:!0,initialising:!1}),this.trigger("init"));return this}});b.admin.ui.formPageParts=function(a,d){a.find("#page_parts").each(function(){d.addObject(b("admin.FormPageParts").init($(this)))})}})(refinery);(function(b){b.Object.create({objectConstructor:function(a,d){var c=this;b.Object.apply(c,arguments);d||(c.options.nested_sortable.stop=function(a,d){c.update(d.item)})},name:"SortableList",module:"admin",options:{nested_sortable:{o:"ul",items:"li",p:1}},set:null,html:null,a:function(a){return a.attr("id")&&/([0-9]+)$/.test(a.attr("id"))?a.attr("id").match(/([0-9]+)$/)[1]:null},update:function(a){var d=this,c=d.holder,e=c.data("update_positions_url"),f=c.nestedSortable("toArray");a={item:{id:d.a(a),
prev_id:d.a(a.prev()),next_id:d.a(a.next()),parent_id:d.a(a.parent().parent())}};d.is("updating")||JSON.stringify(f)===JSON.stringify(d.set)||(d.is({updating:!0,updated:!1}),c.nestedSortable("disable"),b.spinner.on(),$.post(e,a,function(a,e,h){"error"===e?c.html(d.html):(d.set=f,d.html=c.html());b.xhr.success(a,e,h,c);d.is("updated",!0);d.trigger("update")},"JSON").fail(function(a){c.html(d.html);b.xhr.error(a)}).always(function(){b.spinner.off();d.is("updating",!1);c.nestedSortable("enable")}));
