...
{"class":"flash error",html:t("refinery.admin.dialog_content_load_fail")}))}),f.done(function(e,f,g){"success"===f&&(b.empty(),a.d=$("<div/>").appendTo(b),c.xhr.success(e,f,g,a.d),a.n(),a.is("loaded",!0))}),f.always(function(){a.is("loading",!1);b.removeClass("loading");a.trigger("load")}));return this},n:function(){function a(){b.ui&&b.ui.destroy();b.ui=c("admin.UserInterface",{main_content_selector:".dialog-content-wrapper"}).init(b.d);b.ui.subscribe("ui:change",a)}var b=this;a()},bind_events:function(){var a=
