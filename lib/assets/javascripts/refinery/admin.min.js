(function(window, $){'use strict';(function(b){b.admin={ui:{},backend_path:function(){return $("body").data("backend_path")}}})(refinery);(function(b){b.Object.create({name:"Form",module:"admin",o:function(a){var d=this,c,e,b,g;c={text:t("refinery.admin.form_unsaved_save_and_continue"),"class":"submit-button",click:function(){var c=d.holder,b=a.attr("class").match(/flag-([a-z]{2}(?:-[a-zA-Z]{2,3})?)?$/)[1];$("<input/>",{type:"hidden",name:"switch_frontend_locale",value:b}).appendTo(c);c.trigger("before-submit");c.submit()}};e={text:t("refinery.admin.form_unsaved_continue"),click:function(){Turbolinks.visit(a.attr("href"))}};b={text:t("refinery.admin.form_unsaved_cancel"),
click:function(){g.dialog("close")}};g=$("<div/>",{html:t("refinery.admin.form_unsaved_html")}).dialog({resizable:!1,height:140,modal:!0,title:t("refinery.admin.form_unsaved_title"),buttons:[c,e,b]});d.on("destroy",function(){g.dialog("destroy")})},j:function(){var a=this,d=a.holder;d.on("click",".locale-picker a",function(c){a.a!==d.serialize()&&(c.preventDefault(),c.stopPropagation(),a.o($(this)))})},l:function(){var a=this.holder,d=$("meta[name=csrf-param]").attr("content"),c=a.find('input[type="file"]');
if(0<c.length)a.on("submit",function(e){e.preventDefault();e.stopPropagation();b.spinner.on();0===a.find('input[name="'+d+'"]').length&&$("<input/>",{name:d,type:"hidden",value:$("meta[name=csrf-token]").attr("content")}).appendTo(a);a.trigger("before-submit");$.ajax(this.action,{data:a.serializeArray(),files:c,iframe:!0,processData:!1}).done(function(d,c,b){a.trigger("ajax:success",[d,c,b])}).always(function(){b.spinner.off()})})},k:function(){function a(a){a.stopPropagation()}function d(){if(c.is(":valid")){c.removeData("remote");
...
html:t("refinery.admin.dialog_content_load_fail")}))}),e.done(function(e,f,k){f=$("<div/>");c.html(f);b.xhr.success(e,k,f);a.p(f);a.is("loaded",!0)}),e.always(function(){a.is("loading",!1);c.removeClass("loading");a.trigger("load")}));return this},p:function(a){var c=this,e;(function g(){e=b("admin.UserInterface",{main_content_selector:".dialog-content-wrapper"}).init(a);e.subscribe("ui:change",function(){e.destroy();g()});c.on("destroy",function(){e.destroy()})})()},bind_events:function(){var a=
...
[a,d,b])}).always(function(){b.spinner.off()})});c.on("ajax:success",function(c,b){a.upload_area(b)})},upload_area:function(){},n:function(a){a.removeClass("ui-selected");return a.data("dialog")},destroy:function(){this.is("initialised")&&this.holder.dialog("destroy");return this._destroy()},init:function(){var a;this.is("initialisable")&&(this.is("initialising",!0),a=$("<div/>",{id:"dialog-"+this.id,"class":"loading"}),a.dialog(this.options),this.holder=a,this.bind_events(),this.init_buttons(),this.is({initialised:!0,
initialising:!1}),this.trigger("init"));return this}})})(refinery);(function(b){b.Object.create({name:"Picker",module:"admin",elm_current_record_id:null,elm_record_holder:null,elm_no_picked_record:null,elm_remove_picked_record:null,dialog:null,open:function(){this.dialog.init().open();return this},close:function(){this.dialog.close();return this},insert:function(a){return a},destroy:function(){this.dialog.destroy();return this._destroy()},bind_events:function(){var a=this,b=a.holder;b.find(".current-record-link").on("click",function(c){c.preventDefault();a.open()});
