...
"none":"all")).removeClass("hide")});this.holder.on("click",".checkboxes-cmd",function(a){a.preventDefault();a=$(this);var c=a.parent();c.find("input:checkbox").prop("checked",a.hasClass("all"));c.find(".checkboxes-cmd").toggleClass("hide")})},e:function(){this.holder.on("click",".toggle-hide",function(){var a=$(this);$(a.attr("href")).toggleClass("js-hide");a.toggleClass("toggle-on")})},destroy:function(){if(this.is("initialised")){var a=this.a.pop();try{for(;a;)a.destroy(),a=this.a.pop()}catch(c){e.log(c),
e.log(a,this.a)}}return this._destroy()},init:function(a){this.is("initialisable")&&(this.is("initialising",!0),this.holder=a,this.a=[],this.bind_events(),this.d(),this.b(),this.e(),this.initialize_modules(),this.is({initialised:!0,initialising:!1}),this.trigger("init"));return this}})})(refinery);}(window, jQuery));
