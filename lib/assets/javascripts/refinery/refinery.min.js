(function(window, $){'use strict';(function(){function e(){return e.f.apply(e,arguments)}"undefined"===typeof Turbolinks&&(window.Turbolinks={visit:function(a){document.location.href=a}});e.f=function(a,c,b){a=a.split(".");for(var d=this;a.length;)d=d[a.shift()];return new d(c,b)};e.extend=function(a,c){for(var b in c)c.hasOwnProperty(b)&&!a.hasOwnProperty(b)&&(a[b]=c[b]);return a};e.flash=function(a,c){var b=$("#flash-wrapper").empty(),b=$("<div/>",{"class":"flash flash-"+a,html:c}).appendTo(b);0===b.find(".flash-close").length&&
